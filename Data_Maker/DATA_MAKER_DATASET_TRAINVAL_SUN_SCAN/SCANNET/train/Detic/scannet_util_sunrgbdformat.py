...
def make_pseudo_label(classes,masks,img_path):
    ...
    # change path
    src_path = "/share/datasets/scans/scannet_frames_25k" # Replace it with the path to scannet_frames_25k
    tgt_path ="/share/timingyang/OV-3DET/Data_Maker/Detic/demo_output_scnannet_20cls" # Replace it with the path to output path,(e.g. ./scannet_frames_25k_20cls_train)
    scene_path = os.path.join(src_path,scene_name)
    ...
    save_as_ply(xyzrgb,"%s.ply"%(pc_filename))
